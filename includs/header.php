...
<div class="nav-header">
    <div class="brand-logo">
        <a href="<?php APP_URL(); ?>/dashboard/index.php">
            ...
            <p style="font-size: 22px;">our store</p>
            </span>
        </a>
    </div>
</div>
...
<li class="nav-label" style="color: #000; font-weight: 400; font-size: 13px;">Sales</li>
<li class="mega-menu mega-menu-sm">
    <a class="has-arrow" href="javascript:void()" aria-expanded="false">
        <i class="fa fa-shopping-cart menu-icon"></i><span class="nav-text">Sale</span>
    </a>
    <ul aria-expanded="false">
...
<li>
    <a href="index.php"> 
        <i class="fa fa-cog menu-icon"></i><span class="nav-text" style="color: #000; font-weight: 400; font-size: 14px;">Settings</span>
    </a>
</li>
