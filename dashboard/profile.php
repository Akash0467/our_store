                            ...
                            <div class="card-body">
                                <div class="media align-items-center mb-4">
                                    <?php if($profile['photo'] != NULL) :?>
                                        <img class="mr-3" src="../images/user/<?php echo $profile['photo'];?>" width="80" height="80" alt="">
                                    <?php else : ?>
                                    <img class="mr-3" src="../images/user/11.png" width="80" height="80" alt="">
                                    <?php endif; ?>
                                ...
                                <ul class="card-profile__info">
                                    <li class="mb-1"><strong class="text-dark mr-4">Business Name</strong><span><?php echo $profile['buisnessname'];?></span></li>
