...
if(isset($_POST['change_pass_form'])){
    ...
    elseif($new_password != $confirm_new_password){
        $error = "New Password and Confirm Password dosen't match!";
    }
                            ...
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    <form method="POST" action="">
                                        ...
                                        <div class="form-group">
                                            <input type="password" name="confirm_new_password" class="form-control input-default" placeholder="Confirm New Password">
                                        </div>
                                        <div class="form-group">
